    ...
    public class DeckOfCards
    {
        ...
        private List<Card> createDeck()
        {
            List<Card> newDeck = new List<Card>
            {
                ...
                new Card {cardNumber = 14, suit = 2, cardImage = "/Card/Hearts/Ten.gif" },
                new Card {cardNumber = 10, suit = 2, cardImage = "/Card/Hearts/Jack.png" },
                new Card {cardNumber = 11, suit = 2, cardImage = "/Card/Hearts/Queen.gif" },
                new Card {cardNumber = 12, suit = 2, cardImage = "/Card/Hearts/King.gif" },
                new Card {cardNumber = 13, suit = 2, cardImage = "/Card/Hearts/Ace.gif" },
